...
//ErrNoUnicodeEncodingFound No Unicode encoding found
var ErrNoUnicodeEncodingFound = errors.New("No Unicode encoding found")

//ErrUnexpectedSubtableFormat Unexpected subtable format
var ErrUnexpectedSubtableFormat = errors.New("Unexpected subtable format")

//ErrIncorrectMagicNumber Incorrect magic number
var ErrIncorrectMagicNumber = errors.New("Incorrect magic number")

//ErrPostscriptNameNotFound PostScript name not found
var ErrPostscriptNameNotFound = errors.New("PostScript name not found")
...
//ParseByBytes parse []byte
func (t *TTFParser) ParseByBytes(fontdata []byte) error {
	return t.parseByBytes(fontdata)
}
...
func (t *TTFParser) ParseName(fd *bytes.Reader) error {
	...
	if t.postScriptName == "" {
		return ErrPostscriptNameNotFound
	}
...
func (t *TTFParser) ParseCmap(fd *bytes.Reader) error {
	...
	if offset31 == 0 {
		...
		return ErrNoUnicodeEncodingFound
	}
	...
	if format != 4 {
		...
		return ErrUnexpectedSubtableFormat
	}
